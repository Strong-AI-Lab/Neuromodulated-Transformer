...
from training.fine_tuning.gqa_class import *
...
if __name__ == "__main__":
    ...
    train_class = GQA_class(transformer, optimizer, config.loss_object, loss_function, config.tokenizer,
                                     checkpoint_path_recent="/home/kkno604/Documents/V4 results /Specific-fine-tuning/NarrativeQA/Checkpoints/V4_final_model_all_aux_losses_1300_dec_len/",
    ...
    train_class.train_batch(epoch_start=60, epoch_end=80, iteration_counter=0,
                            save_filepath_train="/home/kkno604/Documents/V4 results /Specific-fine-tuning/NarrativeQA/Results/V4_final_model_all_aux_losses_1300_dec_len/",
                            save_filepath_val="/home/kkno604/Documents/V4 results /Specific-fine-tuning/NarrativeQA/Results/V4_final_model_all_aux_losses_1300_dec_len/",
