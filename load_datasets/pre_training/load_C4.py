...
class C4DataLoader:
    ...
    def _get_decoder_lm(self):
        # here implement language modelling...
    ...
    def _get_encoder_mlm(self):
        # TODO: encoder is going to be sentence based. so need to add in <sep> character between sentences.
        input_string = None
        input_id = None
        target_input_id = None
        text_len = len(self.data_id_string[0])  # 0 or 1 doesn't matter.
    ...
    '''
    def __call__(self):
        a = random.randint(0,1) # 0 or 1
        if a == 0: # 0 corresponds to the encoder
    ...
    def __call__(self, mode: str):
        if mode == "enc_dec":
            ...
            input_string, input_id, target_input_id = self._get_decoder_lm()
            return input_string, input_id, target_input_id, self.dec_tok_id, self.mlm_tok_id
...
if __name__ == "__main__":
    ...
    for i in range(5):
        ...
        #TODO: check boundaries of the encoder...
