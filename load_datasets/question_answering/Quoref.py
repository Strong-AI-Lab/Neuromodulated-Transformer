...
class QuorefDataLoader:
    '''
    The implementation of a dataloader for the Quoref dataset to be utilzed by another higher level data loader.
    '''
...
if __name__ == "__main__":
    ...
    dloader = QuorefDataLoader(strategy="train",
                             filepath="/large_data/Quoref/quoref-train-dev-v0.2/quoref-dev-v0.2.json",
