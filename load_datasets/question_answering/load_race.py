...
class RACEDataLoader:
    ...
    def _map_latin_to_int_helper(self, latin: str):
        if latin in ["A", "(A)", "1"]: return self.a1
        elif latin in ["B", "(B)", "2"]: return self.a2
        elif latin in ["C", "(C)", "3"]: return self.a3
        elif latin in ["D", "(D)", "4"]: return self.a4
        elif latin in ["E", "(E)", "5"]: return self.a5
        elif latin in ["F", "(G)", "6"]: return self.a6
        elif latin in ["G", "(G)", "7"]: return self.a7
        elif latin in ["H", "(H)", "8"]: return self.a8
        elif latin in ["I", "(I)", "9"]: return self.a9
