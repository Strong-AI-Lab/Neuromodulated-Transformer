...
if __name__ == "__main__":
    ...
    config = V4ConfigMediumSize(strategy="MirroredStrategy", batch_size=4*GPUS_AVAILABLE,
                                ...
                                learning_rate=CosineDecayLW(start_lr=0.00005, lower_bound_lr=0.00001,
                                                            upper_bound_lr=0.0001, warmup_steps=2000, decay_steps=4000 * 30),
    ...
    train_class = FineTuningClass(transformer, optimizer, config.loss_object, loss_function, config.tokenizer,
                                  checkpoint_path_recent="/home/kkno604/Documents/V4 results/Specific-fine-tuning/NarrativeQA/Checkpoints_1300sl/",
                                  strategy=strategy, pad_token="<pad>", end_tok="</s>",
                                  recent_to_keep=35, load_recent=True,
    ...
    train_class.train_batch_GQA(epoch_start=27, epoch_end=35,
                                save_filepath_train="/home/kkno604/Documents/V4 results/Specific-fine-tuning/NarrativeQA/Results_1300sl/",
                                save_filepath_val="/home/kkno604/Documents/V4 results/Specific-fine-tuning/NarrativeQA/Results_1300sl/",
