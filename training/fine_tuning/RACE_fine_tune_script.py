...
if __name__ == "__main__":
    ...
    config = V4ConfigMediumSize(strategy="MirroredStrategy", batch_size=8*GPUS_AVAILABLE,
                                ...
                                #                            warmup_steps=600, decay_steps=2800*15),
                                vocab_filepath="/data/kkno604/Neuromodulated-Transformer/vocabulary/vocab1.txt",
                                gpt2_117=True,
                                tokenizer="gpt2")
    ...
    train_class.train_batch_MQA(epoch_start=20, epoch_end=30,
                                save_filepath_train="/home/kkno604/Documents/V4 results/Specific-fine-tuning/RACE/Results/",
                                save_filepath_val="/home/kkno604/Documents/V4 results/Specific-fine-tuning/RACE/Results/",
                                data_dict=data_dict, num_aux_tokens=config.num_aux_toks, save_end_epoch=True,
                                print_every_iterations=100, reset_global_step=True)
