...
if __name__ == "__main__":
    ...
    generator_test = dloader_test.get_generator("MCTest_test", False, override_lm=True).batch(config.batch_size)
    ...
    for i in [6,19]:
        ...
        train_class = FineTuningClass(transformer, optimizer, config.loss_object, loss_function, config.tokenizer,
                                      ...
                                      load_specific_path="/home/kkno604/Documents/V4 results/Specific-fine-tuning/MCTest/Checkpoints/ckpt-"+str(200+i),
        ...
        train_class.get_test_results(e=0,
                                     save_filepath="/home/kkno604/Documents/V4 results/Specific-fine-tuning/MCTest/Results/test/",
