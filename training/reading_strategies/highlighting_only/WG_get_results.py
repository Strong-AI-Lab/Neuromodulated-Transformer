...
if __name__ == "__main__":
    ...
    for i in range(1,21):
        ...
        train_class = FineTuningClass(transformer, optimizer, config.loss_object, loss_function, config.tokenizer,
                                      ...
                                      load_specific_path="/data/kkno604/Reading_strategy_experiments/highlighting_only/WG/Checkpoints/ckpt-"+str(240+i),
                                      # load_specific_path="",
        ...
        train_class.get_test_results(e=i-1,
                                     save_filepath="/data/kkno604/Reading_strategy_experiments/highlighting_only/WG/Results/val/",
