...
if __name__ == "__main__":
    ...
    train_class.train_batch_MQA_RS_noMC(epoch_start=0, epoch_end=20,
                                save_filepath_train="/data/kkno604/Reading_strategy_experiments/highlighting_only/MCTest/Results/",
                                save_filepath_val="/data/kkno604/Reading_strategy_experiments/highlighting_only/MCTest/Results/",
