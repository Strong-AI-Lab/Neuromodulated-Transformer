...
from load_datasets.language_modelling.LAMBADA import *
...
if __name__ == "__main__":
    ...
    train_class.get_test_results(e=0,
                                 save_filepath="/data/kkno604/zero-shot-lm/LAMBADA/",
                                 data=data_dict["test"], num_aux_tokens=config.num_aux_toks,
                                 max_generate_len=1, filename_prefix="LAMBADA-test-ckpt-111-768sw", metrics=["accuracy"],
