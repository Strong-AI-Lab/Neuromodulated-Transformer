...
if __name__ == "__main__":
    ...
    train_class.train_batch_GQA(epoch_start=0, epoch_end=20,
                                save_filepath_train="/data/kkno604/Specific-fine-tuning-baseline/BoolQ/Results/",
                                save_filepath_val="/data/kkno604/Specific-fine-tuning-baseline/BoolQ/Results/",
