...
if __name__ == "__main__":
    ...
    config = V4ConfigMediumSize(strategy="MirroredStrategy", batch_size=8*GPUS_AVAILABLE,
                                ...
                                learning_rate=CosineDecayLW(start_lr=0.00005, lower_bound_lr=0.00001,
                                                            upper_bound_lr=0.0001,
                                                            warmup_steps=250, decay_steps=600 * 20),
    ...
    #filepaths = {"BoolQ_test": "/large_data/BoolQ_test/test.jsonl"}
    ...
    for i in range(14,21):
        ...
        train_class = FineTuningClass(transformer, optimizer, config.loss_object, loss_function, config.tokenizer,
                                      ...
                                      load_specific_path="/data/kkno604/Specific-fine-tuning-baseline/BoolQ/Checkpoints/ckpt-"+str(i),
        ...
        train_class.get_test_results(e=0, save_filepath="/data/kkno604/Specific-fine-tuning-baseline/BoolQ/Results/val/",
