...
if __name__ == "__main__":
    ...
    config = V4Wikitext103Medium(strategy="MirroredStrategy", batch_size=2*GPUS_AVAILABLE,
    ...
    data_dict["train"] = dataloader1.get_tf_dataset_generator(process_strategy="sliding_window_article", shuffle=True, pad=True,
                                                             ...
                                                             nm_aux_tokens=["<cls>","<dec>",
                                                                           "<lm>"]).batch(config.batch_size)
    if strategy is not None:
    ...
    train_class.train_iteration(epoch_start=0, epoch_end=10, iteration_counter=0,
                                save_filepath_train="/data/kkno604/NMTransformer_wikitext103/Results/",
                                save_filepath_val="/data/kkno604/NMTransformer_wikitext103/Results/",
