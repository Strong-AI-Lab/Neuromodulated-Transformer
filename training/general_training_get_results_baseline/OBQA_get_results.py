...
if __name__ == "__main__":
    ...
    train_class.get_test_results(e=0, save_filepath="/data/kkno604/General-fine-tuning/gpt2-medium/Results/OBQA_results/test/",
                                 data=data_dict["test"], num_aux_tokens=config.num_aux_toks,
                                 max_generate_len=1, filename_prefix="OBQA-closed-book-test-400k", metrics=["accuracy"],
