...
if __name__ == "__main__":
    ...
    train_class.get_test_results(e=0, save_filepath="/data/kkno604/General-fine-tuning/gpt2-medium/Results/NarrativeQA_results/test/",
                                 data=data_dict["test"], num_aux_tokens=config.num_aux_toks, max_generate_len=100,
                                 filename_prefix="test-400k-768sl", metrics=["rouge-l-score"], mode="GQA", multiple_answers=True)
