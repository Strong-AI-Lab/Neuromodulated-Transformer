...
if __name__ == "__main__":
    ...
    generator_test = dloader_test.get_generator("SQuAD_test_default", False, override_lm=False).batch(config.batch_size)
    ...
    train_class.get_test_results(e=0, save_filepath="/data/kkno604/General-fine-tuning/gpt2-medium/Results/SQuAD_results/val/",
