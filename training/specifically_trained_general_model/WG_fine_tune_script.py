...
if __name__ == "__main__":
    ...
    train_class = FineTuningClass(transformer, optimizer, config.loss_object, loss_function, config.tokenizer,
                                  checkpoint_path_recent="/data/kkno604/Specifically_fine_tuned_general_model/WG/checkpoints/",
    ...
    train_class.train_batch_MQA(epoch_start=0, epoch_end=20,
                                save_filepath_train="/data/kkno604/Specifically_fine_tuned_general_model/WG/results/",
                                save_filepath_val="/data/kkno604/Specifically_fine_tuned_general_model/WG/results/",
