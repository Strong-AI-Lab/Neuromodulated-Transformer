...
if __name__ == "__main__":
    ...
    for i in range(1,3):
        ...
        train_class = FineTuningClass(transformer, optimizer, config.loss_object, loss_function, config.tokenizer,
                                      checkpoint_path_recent="/data/kkno604/Specifically_fine_tuned_general_model/MCTest/checkpoints/",
                                      ...
                                      load_specific_path="/data/kkno604/Specifically_fine_tuned_general_model/MCTest/checkpoints/ckpt-"+str(240+i),
        ...
        train_class.get_test_results(e=i-1,
                                     save_filepath="/data/kkno604/Specifically_fine_tuned_general_model/MCTest/results/test/",
