...
if __name__ == "__main__":
    ...
    train_class.train_batch_MQA(epoch_start=0, epoch_end=20,
                                save_filepath_train="/data/kkno604/Specifically_fine_tuned_general_model/PIQA/results/",
                                save_filepath_val="/data/kkno604/Specifically_fine_tuned_general_model/PIQA/results/",
