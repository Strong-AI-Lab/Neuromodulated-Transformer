...
if __name__ == "__main__":
    ...
    for i in range(1,21):
        ...
        train_class = FineTuningClass(transformer, optimizer, config.loss_object, loss_function, config.tokenizer,
                                      ...
                                      load_specific_path="/data/kkno604/Specifically_fine_tuned_general_model/WG/checkpoints/ckpt-"+str(240+i),
        ...
        train_class.get_test_results(e=0,
                                     save_filepath="/data/kkno604/Specifically_fine_tuned_general_model/WG/results/val/",
