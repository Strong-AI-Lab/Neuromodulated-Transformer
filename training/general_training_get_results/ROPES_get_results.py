...
if __name__ == "__main__":
    ...
    #filepaths = {"ROPES_test": "/large_data/ROPES/ropes-train-dev-v1.0/dev-v1.0.json"}
    filepaths = {"ROPES_test": "/large_data/contrast-sets/ropes/data/ropes_contrast_set_032820.json"}
    ...
    generator_test = dloader_test.get_generator("ROPES_test", False, override_lm=False).batch(config.batch_size)
    ...
    train_class.get_test_results(e=0, save_filepath="/home/kkno604/Documents/V4 results/General-fine-tuning/Default/Results/ROPES_results/cset/",
                                 data=data_dict["test"], num_aux_tokens=config.num_aux_toks, max_generate_len=100,
                                 filename_prefix="cset-400k-f1-score-fixed", metrics=["f1-score","", "",
