...
if __name__ == "__main__":
    ...
    filepaths = {"SIQA_test": {"question":"/large_data/SIQA/socialiqa-train-dev/dev.jsonl",
                              "labels":"/large_data/SIQA/socialiqa-train-dev/dev-labels.lst"}}
    ...
    generator_test = dloader_test.get_generator("SIQA_test", False, override_lm=False).batch(config.batch_size)
    ...
    train_class.get_test_results(e=0, save_filepath="/home/kkno604/Documents/V4 results/General-fine-tuning/Default/Results/SIQA_results/val/",
                                 data=data_dict["test"], num_aux_tokens=config.num_aux_toks,
                                 max_generate_len=1, filename_prefix="SIQA-val-400k", metrics=["accuracy"],
