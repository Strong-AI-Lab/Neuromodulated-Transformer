...
if __name__ == "__main__":
    ...
    filepaths = {"OBQA_test": "/large_data/OpenBookQA-V1-Sep2018/Data/Main/test.jsonl"}
    ...
    generator_test = dloader_test.get_generator("OBQA_test", False, override_lm=False).batch(config.batch_size)
    ...
    train_class.get_test_results(e=0, save_filepath="/home/kkno604/Documents/V4 results/General-fine-tuning/Default/Results/OBQA_results/test/",
                                 data=data_dict["test"], num_aux_tokens=config.num_aux_toks,
                                 max_generate_len=1, filename_prefix="OBQA-closed-book-val-400k", metrics=["accuracy"],
