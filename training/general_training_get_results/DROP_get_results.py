...
if __name__ == "__main__":
    ...
    filepaths = {"DROP_test": "/large_data/DROP/drop_dataset_with_test_questions/drop_dataset_dev.json"}
    #filepaths = {"DROP_test": "/large_data/contrast-sets/DROP/drop_contrast_sets_test.json"}
    ...
    generator_test = dloader_test.get_generator("DROP_test", False, override_lm=False).batch(config.batch_size)
    data_dict = {}
    ...
    train_class.get_test_results(e=0, save_filepath="/home/kkno604/Documents/V4 results/General-fine-tuning/Default/Results/DROP_results/val/",
                                 data=data_dict["test"], num_aux_tokens=config.num_aux_toks, max_generate_len=100,
                                 filename_prefix="val-400k", metrics=["rouge-l-score"], mode="GQA", multiple_answers=True)
