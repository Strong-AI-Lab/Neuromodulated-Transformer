...
if __name__ == "__main__":
    ...
    generator_test = dloader_test.get_generator("NarrativeQA_test", False, override_lm=False).batch(config.batch_size)
    ...
    train_class.get_test_results(e=0, save_filepath="/home/kkno604/Documents/V4 results/General-fine-tuning/Default/Results/NarrativeQA_results/test/",
                                 data=data_dict["test"], num_aux_tokens=config.num_aux_toks, max_generate_len=100,
                                 filename_prefix="test-400k-1300sl", metrics=["rouge-l-score"], mode="GQA", multiple_answers=True)
