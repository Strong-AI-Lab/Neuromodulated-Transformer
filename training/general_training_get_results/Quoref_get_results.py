...
if __name__ == "__main__":
    ...
    #filepaths = {"Quoref_test": "/large_data/Quoref/quoref-train-dev-v0.2/quoref-dev-v0.2.json"}
    filepaths = {"Quoref_test": "/large_data/contrast-sets/quoref/quoref_test_perturbations_20191206_merged.json"}
    ...
    generator_test = dloader_test.get_generator("Quoref_test", False, override_lm=False).batch(config.batch_size)
    ...
    train_class.get_test_results(e=0, save_filepath="/home/kkno604/Documents/V4 results/General-fine-tuning/Default/Results/Quoref_results/cset/",
                                 data=data_dict["test"], num_aux_tokens=config.num_aux_toks, max_generate_len=100,
                                 filename_prefix="val-400k-f1-score-cset", metrics=["f1-score","", "",
