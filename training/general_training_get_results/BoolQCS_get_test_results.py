...
if __name__ == "__main__":
    ...
    filepaths = {"BoolQCS_test": "/large_data/contrast-sets/BoolQ/boolq_perturbed.json"}
    ...
    generator_test = dloader_test.get_generator("BoolQCS_test", False, override_lm=False).batch(config.batch_size)
    ...
    train_class.get_test_results(e=0, save_filepath="/home/kkno604/Documents/V4 results/General-fine-tuning/Default/Results/BoolQ-CS_results/val/",
                                 data=data_dict["test"], num_aux_tokens=config.num_aux_toks, max_generate_len=1,
                                 filename_prefix="val-epoch-400k-iterations", metrics=["accuracy"], mode="GQA", multiple_answers=False)
